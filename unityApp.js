const unityApp = {
    ...
    tryRotationLock() {
        ...
        if (isPortraitLocked) {
            image.src = 'https://cdn.jsdelivr.net/gh/yeodaienkyle-afk/clickspeed@main/TemplateData/portrait-only.png';
        }
        else if (isLandscapeLocked) {
            image.src = 'https://cdn.jsdelivr.net/gh/yeodaienkyle-afk/clickspeed@main/TemplateData/landscape-only.png';
        }
    ...
    startLoading: function () {
        ...
        const buildUrl = "https://cdn.jsdelivr.net/gh/yeodaienkyle-afk/clickspeed@main/Build";
